        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    if(row.is_active){return '<span class="badge badge-primary">'+'Activo'+'</span>'
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, row) {   
                    let buttons = '<a href="/usuario/editar/' + row.id + '/" class="btn btn-warning btn-xs"><i class="fas fa-edit"></i></a> ';
