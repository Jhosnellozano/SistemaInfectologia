...
$(function () {
        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {   
                    let buttons = '<a href="/hospital/cita/editar/' + row.id + '/" class="btn btn-warning btn-xs"><i class="fas fa-edit"></i></a> ';
    ...
    $('#data_list tbody').on('click', 'a[rel="delete"]', function () {
        ...
        submit_with_ajax(url, 'Notificación', '¿Estas seguro de eliminar la cita ' + '<b style="color: #304ffe;">' +  data.id + '</b>?', parameters, function () {
